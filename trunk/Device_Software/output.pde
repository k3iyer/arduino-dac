...
// The output processor is what takes the data that is stored in the profiles and decides how it effects the hardwares configureation.
// That is it decides if the hardware is constant current, constant voltage, or constant power mode.
// It controls the serpoint of the load and charge banks.
